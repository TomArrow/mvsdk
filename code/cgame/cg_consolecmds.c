...
static void CG_spWin_f( void) {
	...
	//trap_S_StartLocalSound(cgs.media.winnerSound, CHAN_ANNOUNCER); // commented out by jkplus
...
static void CG_spLose_f( void) {
	...
	//trap_S_StartLocalSound(cgs.media.loserSound, CHAN_ANNOUNCER); // commented out by jkplus
...
static consoleCommand_t	commands[] = {
	...
	{ "strafehelper_jkplus", JKMod_CG_StrafeHelperToggle },	// Tr!Force: [StrafeHelper] Toggle command
	{ "speedometer_jkplus", JKMod_CG_SpeedMeterToggle }			// Tr!Force: [SpeedMeter] Toggle command
};
