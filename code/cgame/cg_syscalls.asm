...
equ trap_CG_COOL_API_Benchmark					-1112	;CG_COOL_API_BENCHMARK 
equ trap_CG_COOL_API_PointContentsHullFast		-1113	;CG_COOL_API_POINTCONTENTSHULLFAST 
equ trap_CG_COOL_API_MakeASCIIMinimap			-1114	;CG_COOL_API_MAKEASCIIMINIMAP 
