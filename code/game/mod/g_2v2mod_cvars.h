...
#define TVT_CVAR_LIST                                                                                                                                                \
    ...
    TVT_CVAR(tvt_teamSize, "0", "Max players per team, 0 = no limit", CVAR_ARCHIVE, qtrue, NULL)                                                                     \
    TVT_CVAR(tvt_allowSuicide, "1", "Allow players to use the kill command in team based gametypes.", CVAR_ARCHIVE, qtrue, NULL)
