...
equ trap_G_COOL_API_SendBackUCMD_GameGenerated			-1109	;G_COOL_API_SENDBACKUCMD_GAMEGENERATED 
equ trap_G_COOL_API_CustomEpsilonTrace					-1110	;G_COOL_API_CUSTOMEPSILONTRACE 
