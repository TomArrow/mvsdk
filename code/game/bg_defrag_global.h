...
#define IRONMAN_MAX_PAST_POSITIONS_COUNT_QUICK 5 // these are done every 200 ms. so when we land on ground, we can pick one from before we landed.
#define IRONMAN_SAVEPOSITION_QUICK_MINTIME 200
#define IRONMAN_SAVEPOSITION_MINDISTANCE 100.0f
#define IRONMAN_SAVEPOSITION_MINDISTANCE_SHORT 50.0f
#define IRONMAN_SAVEPOSITION_MINTIMEFORCE 500
#define IRONMAN_SAVEPOSITION_MINTIMEFORCESURELY 1000
#define IRONMAN_SAVEPOSITION_MINTIMEFORCESURELYEVENJUMP 5000
#define IRONMAN_SAVEPOSITION_MINTIMEFORCESURELYEVENJUMP2 7000
#define IRONMAN_RESPAWNPOSITION_REFERENCESPEED 750.0f
#define IRONMAN_RESPAWNPOSITION_MINDISTANCE 1200.0f
#define IRONMAN_RESPAWNPOSITION_MINDISTANCE_MEDIUM 700.0f
#define IRONMAN_RESPAWNPOSITION_MINDISTANCE_SHORT 350.0f // for emergencies idk
#define IRONMAN_RESPAWNPOSITION_MAXDISTANCE 1500.0f
#define IRONMAN_RESPAWNPOSITION_MAXDISTANCE_LONG 2500.0f
#define IRONMAN_RESPAWNPOSITION_MAXPOSITIONAGE 15000
