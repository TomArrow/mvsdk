...
Handle UI console commands and prevent recursive vmMain calls
=================
*/
qboolean UI_ConsoleCommand(int realTime)
{
	...
	static qboolean processing = qfalse;
	if (processing)
	{
		return qfalse;
	}
	...
	// Handle basic UI commands with proper return values
